...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO petugas_koperasi (id_petugas, nama, alamat, ket) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "petugas-koperasi.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="content">
  ...
  <input type="text" name="id_petugas" value="" size="32" placeholder="id petugas" />
