...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pinjaman (id_pinjaman, nama_pinjaman, id_anggota, besar_pinjaman, tgl_pengajuan_pinjaman, tgl_acc_peminjam, tgl_pinjaman, tgl_pelunasan, id_angsuran, ket) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="content">
  ...
  <input type="text" name="id_pinjaman" value="" size="32" placeholder="id pinjaman" />
  <input type="text" name="nama_pinjaman" value="" size="32" placeholder="nama pinjaman"/>
    <input type="text" name="id_anggota" value="" size="32" placeholder="id anggota" />
   <input type="text" name="besar_pinjaman" value="" size="32" placeholder="besar pinjaman"/>
   <input type="text" name="tgl_pengajuan_pinjaman" value="" size="32" placeholder="tgl pengajuan pinjaman" />
    <input type="text" name="tgl_acc_peminjam" value="" size="32"  placeholder="tgl acc peminjam"/>
    <input type="text" name="tgl_pinjaman" value="" size="32" placeholder="tgl pinjaman" />
    <input type="text" name="tgl_pelunasan" value="" size="32" placeholder="tgl pelunasan" />
    <input type="text" name="id_angsuran" value="" size="32" placeholder="id angsuran" />
