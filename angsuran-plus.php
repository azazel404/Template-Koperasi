...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO angsuran (id_angsuran, id_katagori, id_anggota, tgl_pembayaran, angsuran_ke, besar_angsuran, ket) VALUES (%s, %s, %s, %s, %s, %s, %s)",
	...
	<div style="padding: 30px;">
            ...
            <form  class="admin-edit"action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
             <input type="text" name="id_angsuran" value="" size="32" placeholder="id angsuran" />
                <input type="text" name="id_katagori" value="" size="32" placeholder="id katagori" />
                <input type="text" name="id_anggota" value="" size="32" placeholder="id anggota" />
               <input type="text" name="tgl_pembayaran" value="" size="32" placeholder="tgl pembayaran" />
            <input type="text" name="angsuran_ke" value="" size="32" placeholder="angsuran ke"/>
                <input type="text" name="besar_angsuran" value="" size="32" placeholder="besar angsuran" />
