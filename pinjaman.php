...
<body>
<a class="btn-fix plus cardh" href="pinjaman-plus.php"></a>
<a class="btn-print print cardh" href="pinjaman-report.php"></a>	
...
<form id="form1" name="form1" method="post" action="pinjaman-search.php">
    ...
    <th>ket</td>
      ...
      <td><?php echo $row_Recordset1['ket']; ?></td>
				<td><a class="btn-tab edit" href=" pinjaman-edit.php?id_pinjaman=<?php echo $row_Recordset1['id_pinjaman']; ?>"></a></td>
				<td><a class="btn-tab delete" href="pinjaman-delete.php?id_pinjaman=<?php echo $row_Recordset1['id_pinjaman']; ?>"></a></td>
			</tr>
